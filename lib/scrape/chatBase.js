...
async function ChatBase() {
  var url = "https://www.chatbase.co";
  var supports_gpt_35_turbo = true;
  var supports_gpt_4 = true;
  var working = true;

  var async createAsyncGenerator(model, messages, kwargs) {
    let chat_id = "";
